namespace Ofinger
{
	partial class Outfits
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Outfits));
			...
			label3.Location = new Point(1601, 78);
			label3.Name = "label3";
			label3.Size = new Size(182, 80);
			label3.TabIndex = 3;
			label3.Text = "Outfits";
			// 
			// Outfits
